...
<form action="/PAP_Site/Back/AltConta.php" method="post">
    ...
    <h3>Conta</h3>
    <br>  <br> 
    <?php echo('<input style="min-width: 10em"; class="form-control" type="text" value="'.$_SESSION['username'].'" readonly>')?>
    <br> 
    <input style="min-width: 10em"; class="form-control" placeholder="Password Atual da Conta" type="password" name="Veri1password" id="Veri1JSpassword"><br>
    ...
    <input style='min-width: 10em'; class='form-control' placeholder='Nova Password' type='password' name='Veri3password' id="Veri3password" pattern='.{6,}' required title='A Password tem de ter pelo menos 6 carateres.'>
    <br>
    <input style='min-width: 10em'; class='form-control' placeholder=' Confirme a nova Password' type='password' name='Veri4password' id="Veri4password" pattern='.{6,}' required title='A Password tem de ter pelo menos 6 carateres.'>
    <div id="changes"></div>
    <div id="Confirm"></div>
...
<form action="/PAP_Site/Back/AltConta.php" method="post">
    ...
    <h3>Conta</h3>
    <br>  <br> 
    <?php echo('<input class="form-control" type="text" value="'.$_SESSION['username'].'" readonly>')?>
    <br> 
    <input style="min-width: 10em"; class="form-control" placeholder="Password Atual da Conta" type="password" name="Veri1password" id="Veri1JSpassword"><br>
    <!-- <input style="min-width: 10em"; class="form-control" placeholder="Verificar Password" type="password" name="Veri2password" id="Veri2JSpassword" onChange="checkPasswordMatch();"><br> -->            
    <input style='min-width: 10em'; class='form-control' placeholder='Nova Password' type='password' name='Veri3password' id="Veri3password" pattern='.{6,}' required title='A Password tem de ter pelo menos 6 carateres.'>
